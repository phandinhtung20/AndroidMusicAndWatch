...
import com.tung.mysmartwatch.ui.activities.ConfigureActivity;
...
//            stopSelf();
    ...
    private void showNotification() {
        ...
        bigViews.setImageViewBitmap(R.id.status_bar_album_art, Constant.getDefaultAlbumArt(this));

        Intent notificationIntent = new Intent(this, ConfigureActivity.class);
